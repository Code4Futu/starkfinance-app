...
export const ModalEditListing = (props: Props) => {
  ...
  return (
    <div>
      <div className="modal-overlay">
        <div
          ref={wrapperRef}
          className="w-full flex justify-center items-center lg:items-start border-t-[1px] border-[#2D313E] bg-[#1A1C24] edit-listing-content-modal"
        >
          <div className="w-full flex py-9 px-6 flex-col items-start gap-6">
            ...
            <div className="flex justify-center items-start gap-6 self-stretch">
              <div className="flex flex-col items-start p-3 gap-2 flex-1 rounded-2xl border-[1px] border-[#2D313E] bg-[#0D0E12]">
                ...
                <div className="w-full flex justify-between items-start self-stretch text-xs font-medium text-[#c6c6c6] leading-[14px]">
                  <div>$ 0</div>
                  <div>Balance: 1 ETH</div>
                </div>
              </div>
            </div>
            <Divider />
            ...
            <div className="flex items-start gap-6 self-stretch">
              <div className="w-full flex justify-center items-center gap-1 py-3 px-6 self-stretch rounded-2xl border-[1px] border-[#2D313E] cursor-pointer hover:bg-[#3C3D4D] transition-all">
                <span className="text-base font-bold text-[#FF6C6C] leading-[19px]">
                  Cancel listing
                </span>
              </div>
              <div className="w-full flex justify-center items-center gap-1 py-3 px-6 self-stretch rounded-2xl cursor-pointer button-linear-1">
