	...
	return (
		<div>
			<div className="modal-overlay">
				<div
					ref={wrapperRef}
					className="w-full flex justify-center items-center lg:items-start border-t-[1px] border-[#2D313E] bg-[#1A1C24] transfer-content-modal"
				>
					<div className="w-full flex py-9 px-6 flex-col items-start gap-6">
						...
						<Input
							className="h-[48px] p-3 border-[#2D313E] rounded-2xl"
