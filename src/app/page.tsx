				...
				<div className="grid grid-cols-1 md:grid-cols-2 mt-4 gap-6">
					<div className="rounded-3xl bg-[#1A1C24] px-6 pb-6 flex flex-col gap-6 items-center">
						...
						<div className="text-[14px] text-center">
							...
							wallet. Ensure you have enough ETH to pay gas on Starknet Chain.
						</div>
					</div>
					<div className="rounded-3xl bg-[#1A1C24] px-6 pb-6 flex flex-col gap-6 items-center">
						<div className="bg-gradient-to-r from-[#24C3BC] to-[#ADFFFB] font-bold text-[#1A1C24] py-3 px-6 lg:px-24 rounded-b-2xl">
						...
						<div className="text-[14px] text-center">
							IDO pool will be opened on 3 days (72 hours) and you can commit
							SFN tokens on it, you can also stake your StarkFinance NFT to
					...
					<div className="rounded-3xl bg-[#1A1C24] px-6 pb-6 flex flex-col gap-6 items-center">
						...
						<div className="text-[14px] text-center">
							...
							participants committing funds in the pool and show how many IDO
							tokens you can buy depends on your committing amount. Then the
							corresponding SFN amount will be deducted from your deposited
							fund.
						</div>
					</div>
					<div className="rounded-3xl bg-[#1A1C24] px-6 pb-6 flex flex-col gap-6 items-center">
						...
						<div className="text-[14px] text-center">
							You can enter launchpad platform and claim your IDO tokens also
							your remaining SFN fund.
						</div>
					</div>
				</div>
			</div>
