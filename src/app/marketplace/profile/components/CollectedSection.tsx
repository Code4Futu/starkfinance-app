...
export const CollectedSection = ({
  ...
  const [openListingModal, setOpenListingModal] = useState<boolean>(false);
  return (
    <>
      <div
        className={clsx(
        ...
        {mockupCollections().map((item, idx) => (
          <div
            ...
            className={clsx(
              ...
              view === "small" && "max-w-[165px] lg:max-w-[198px]",
              view === "large" && "max-w-[346px]",
              selectedItem.find((e) => e === item.address) !== undefined &&
                "!border-[#24C3BC]"
            )}
          >
            <div
      ...
      {openListingModal && (
        <ModalListing isShowing={openListingModal} hide={setOpenListingModal} />
      )}
    </>
  );
};
