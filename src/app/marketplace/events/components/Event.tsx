...
export const Event = ({ event }: { event: IEvent | undefined }) => {
  ...
  return (
    <div
      ...
      className="flex items-end w-full min-h-[228px] md:min-h-[232.218px] lg:min-h-[355px] rounded-3xl border-[1px] border-[#2D313E] max-w-[348px] lg:max-w-[532px]"
    >
      <div
        style={{
          background:
            ...
            <div className="flex items-start gap-1">
              ...
              <div
                ...
                className={clsx(
                  ...
                  {
                    "border-[#FFE86C]": event.status === EVENT_STATUS.UPCOMING,
                  },
                  {
              ...
              >
                ...
                <span
                  className={clsx(
                    ...
                    {
                      "text-[#FFE86C]": event.status === EVENT_STATUS.UPCOMING,
                    },
                    {
