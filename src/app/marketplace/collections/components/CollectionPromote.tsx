...
export const CollectionPromote = () => {
	const collection = mockupCollections()[0];
	return (
		<>
			<div className="md:hidden w-full">
				<div className="flex w-full flex-col items-start rounded-3xl border-[1px] border-[#2D313E] bg-[#1A1C24] overflow-hidden">
					<div
						...
						className="flex w-full flex-col justify-end items-start h-[171px] !bg-no-repeat !bg-[length:100%_100%]"
					/>
					<div
			...
			<div className="hidden md:flex w-full">
				<div
					...
					className="w-full h-[360px] rounded-3xl !bg-no-repeat !bg-[length:100%_360px]"
				>
					<div className="p-6 flex w-full h-full flex-col justify-end items-start gap-3 rounded-3xl border-[1px] border-[#2D313E]">
						...
						<div className="flex justify-between items-end self-stretch">
							...
							<ViewCollectionButton
								url={`/marketplace/collections/${collection.address}`}
								title={"View Collection"}
							/>
						</div>
					</div>
