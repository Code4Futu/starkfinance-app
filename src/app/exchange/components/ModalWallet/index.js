...
const ModalWallet = ({ isShowing, hide }) => {
	...
	return isShowing
		? ReactDOM.createPortal(
				<React.Fragment>
					<div className="modal-overlay-v1" />
					<div
						...
						>
							...
							{!showWallet ? (
								<div className="flex px-6 pt-6 pb-9 flex-col items-start gap-[10px]">
									...
									>
										<img src={icons.v2.zeta} alt="" className="h-6 w-6" />
										<span className="text-base font-bold  text-[#F1F1F1]">
											Zetachain
										</span>
									</div>
									...
									>
										<img src={icons.v2.opside} alt="" className="h-6 w-6" />
										<span className="text-base font-bold  text-[#F1F1F1]">
											Opside
										</span>
									</div>
								...
								<div className="flex px-6 pt-6 pb-9 flex-col items-start gap-[10px]">
									...
									>
										<img src={icons.v2.argent} alt="" className="h-6 w-6" />
										<span className="text-base font-bold  text-[#F1F1F1]">
											ArgentX
										</span>
									</div>
									...
									>
										<img src={icons.v2.braavos} alt="" className="h-6 w-6" />
										<span className="text-base font-bold  text-[#F1F1F1]">
											Braavos
										</span>
									</div>
									...
									>
										<img src={icons.v2.okx} alt="" className="h-6 w-6" />
										<span className="text-base font-bold  text-[#F1F1F1]">
											OKX
										</span>
									</div>
